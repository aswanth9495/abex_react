export async function apiRequest(method: string, url: string, data?: any): Promise<any> {
  ...
  return parseJsonResponse(response) // Parse response using the parseJsonResponse function
}
...
export async function parseJsonResponse(response: Response): Promise<any> {
  ...
  try {
    ...
    // For example, you can log an error message or perform specific error handling
